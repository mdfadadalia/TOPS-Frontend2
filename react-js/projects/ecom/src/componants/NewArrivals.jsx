...
const NewArrivals = () => {
    return (
        <section className="new__arrivals container section">
            ...
            <div className="new__arrivals container swiper">
                {/* NAVIGATION */}
                ...
                <div className="categories__buttons">
                    <div className="new_swiper-button-prev custom-swiper-btn">

                    </div>
                    <div className="new_swiper-button-next custom-swiper-btn">
